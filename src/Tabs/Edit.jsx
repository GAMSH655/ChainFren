  ...
  return (
    <div className="flex h-screen bg-white">
      ...
      <div className="flex-1 md:ml-64 overflow-auto">
        ...
        <span></span>
        <button className="bg-gray-200 px-4 py-2 rounded-lg"  onClick={modalHandler}>Delete</button>
        </div>
      ...
      { openModal && (
        ...
        <div className="p-3">
          <label className="text-sm font-semibold text-[#DFE0E1] flex items-center">
            Product Name
          </label>
          <input
            type="text"
        ...
        <div className="p-3">
          <label className="text-sm font-semibold text-[#53525f] flex items-center">
            Upload Image
          </label>
          <input
            type="file"
        ...
        <div className="p-3">
          ...
          <textarea
            className="w-full h-24 p-2 mt-1 border-2 border-[#53525f] rounded-md resize-none focus:outline-none"
          ></textarea>
        </div>
        <div className="flex">
